...
export default function LoginForm() {
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] px-4 py-10 text-[#0f172a] sm:px-6 lg:px-8">
        ...
        <div className="relative grid w-full overflow-hidden rounded-[24px]   sm:p-10 lg:grid-cols-[1fr_0.92fr] lg:gap-14 lg:p-12">
          ...
          <div className="relative z-10 mt-10 flex items-center lg:mt-16">
            <div className="w-full">
              <h1 className="text-[34px] font-bold leading-tight text-[#0b1220]">Welcome back</h1>
              <p className="mt-3 text-[15px] text-[#64748b]">Login to continue reviewing your code.</p>
              ...
              <form onSubmit={handleSubmit} className="mt-12 space-y-6">
                ...
                <div className="flex justify-end">
                  <Link href="#" className="text-sm font-medium text-[#e8a900]">
                    Forgot password?
                  </Link>
                </div>
              ...
              <p className="mt-6 text-center text-sm text-[#475569]">
                ...
                <Link href="/register" className="font-semibold text-[#e8a900]">
                  Register
                </Link>
              </p>
            </div>
...
function BottomTab({ label }: { label: string }) {
  return (
